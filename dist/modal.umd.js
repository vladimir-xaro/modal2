!function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).Modal = e();
}(this, (function() {
    "use strict";
    class t {
        /**
 ...
 // the presence of a class for at least one element of the set
    ...
    class h {
        ...
        pending=!1;
        constructor(e) {
            this.emitter = new t(e.on), this.els = Array.isArray(e.el) ? o(...e.el) : o(e.el);
            ...
            //   this.allow = events;
            // }
            Object.keys(r).forEach((t => this[r[t]] = this[r[t]].bind(this))), this.els.forEach((t => this.allow.forEach((e => t.addEventListener(e, this[r[e]])))));
        }
        ...
        addEvent(t) {
            a.includes(t) && (this.allow.push(t), this.els.forEach((e => e.addEventListener(t, this[r[t]]))));
        }
        removeEvent(t) {
            a.includes(t) && this.allow.includes(t) && (this.allow.splice(this.allow.indexOf(t)), 
            this.els.forEach((e => e.removeEventListener(t, this[r[t]]))));
        }
        on(t, e) {
